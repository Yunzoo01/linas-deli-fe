...
const menuItems = [
    ...
    { id: 3, category: "Popular", img: popular3, name: "Charcuterie Bite" },
    { id: 4, category: "Popular", img: popular4, name: "Jerky" },
    { id: 5, category: "Meat", img: meat1, name: "Jerky" },
    ...
    { id: 9, category: "Cheese", img: cheese1, name: "Truffle Cheese" },
