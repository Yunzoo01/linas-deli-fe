const About = () => {
    return (
        <section className="h-auto mx-auto lg:h-auto lg:px-20 lg:pt-16 lg:pb-40 lg:bg-[#FFFAEF]">
            {/* 제목 */}
            <h2 className="lg:text-5xl text-2xl font-bold px-[1.5rem] my-[2.9rem] lg:text-center lg:mb-12">About</h2>
            ...
            <div className=" relative flex flex-col lg:flex-row items-center gap-12 gap-20">
                ...
                <div className="relative  w-full h-[24rem] rounded-tr-lg rounded-br-lg lg:rounded-br-xl">
                    ...
                    <div className="z-50 flex flex-col gap-3 lg:gap-5 absolute lg:-right-8 lg:-bottom-8 right-7 bottom-6 bg-white p-6 lg:p-8 rounded-lg shadow-lg w-[75%] lg:w-[80%]">
                        <h3 className="text-base lg:text-2xl font-semibold mb-2 lg:mb-4">Come and visit us</h3>
                        <p className="flex text-xs lg:text-lg items-center gap-2 text-gray-600">
                        ...
                        <p className="flex text-xs lg:text-lg items-start gap-2 text-gray-600">
                ...
                <div className="flex w-full bg-[#FFFAEF] flex-col justify-center gap-4 px-[1.5rem] py-12 -mt-30 h-[20rem]">
                    <h3 className="text-black mt-16 font-pretendard text-[1.25rem] lg:text-4xl lg:mb-4 font-medium leading-[1.75rem] lg:leading-none">
                        We provide healthy <br></br>food for your family.
                    </h3>
                    <p className="text-black font-pretendard text-[0.6875rem] lg:text-xl font-light leading-[1.10081rem] lg:leading-snug">
