...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[rgba(255,255,255,0.85)] shadow absolute sm:fixed top-0 left-0 w-full z-50 max-w-[120rem] mx-auto">
      ...
      {/* 모바일 메뉴 */}
      <div
        className={`sm:hidden fixed top-0 right-0 w-40 h-full bg-white shadow-lg p-4 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
